# https://github.com/khj1259/Spring_Study/blob/master/%EC%9D%BC%ED%83%80%EC%82%AC%ED%94%BC/Sample%20Code/%EC%B5%9C%EC%A2%85%EC%86%8C%EC%8A%A4_stage3_%EA%B9%80%ED%98%84%EC%A0%95.java
...
def play(conn, gameData):
    ...
    for target_idx, pwr in [(1, 115), (2, 115), (3, 105), (4, 115)]:
