# https://github.com/khj1259/Spring_Study/blob/master/%EC%9D%BC%ED%83%80%EC%82%AC%ED%94%BC/Sample%20Code/%EC%B5%9C%EC%A2%85%EC%86%8C%EC%8A%A4_stage456_%EA%B9%80%ED%98%84%EC%A0%95.java
...
def play(conn, gameData):
    ...
    # Stage 4~6 로직: 살아있는 공 중 가장 먼저 나오는 공 타깃
    for target_idx, pwr in [(1, 130), (2, 115), (3, 105), (4, 115)]:
        tx, ty = gameData.balls[target_idx]
        if tx != 0 or ty != 0:  # 좌표가 (0,0)이 아니라면 공 존재
